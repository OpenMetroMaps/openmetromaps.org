...
mkdir -p res/client/stuttgart
cp ../../../OpenMetroMapsData/stuttgart/sbahn-geographic.omm res/client/stuttgart/
cp ../../../OpenMetroMapsData/stuttgart/sbahn-schematic.omm res/client/stuttgart/
